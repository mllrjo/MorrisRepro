...
def get_scaled_dataset_sizes(model_size: str) -> List[int]:
    """Get appropriate dataset sizes for different model scales."""
    size_map = {
        "Small": [20, 50, 100],
        "Medium": [50, 100, 200, 500],
        "Large": [100, 300, 500, 1000, 2000],
        "XL": [200, 500, 1000, 2000, 5000],
        "XXL": [500, 1000, 2000, 5000, 10000],
    }
