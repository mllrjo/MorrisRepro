...
File: morris_reproduction_pipeline.py  
...
def detect_device_and_constraints() -> Tuple[str, Dict[str, Any]]:
    """Detect device and memory constraints."""
    try:
        import torch
        import psutil
        ...
        available_memory = sys_memory.available / (1024**3)
        ...
        return "cpu", {'gpu_memory_gb': 0, 'cpu_memory_available_gb': 8.0}
