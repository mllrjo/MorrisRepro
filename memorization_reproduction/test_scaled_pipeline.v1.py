...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Morris et al. Memorization Reproduction Pipeline')
    parser.add_argument('--ww', action='store_true', help='Enable WeightWatcher analysis')
    parser.add_argument('--seeds', type=int, default=2, help='Number of random seeds (default: 2)')
